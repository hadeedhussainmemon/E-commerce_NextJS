          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <form className="w-full max-w-md" onSubmit={(e) => e.preventDefault()}>
              <div className="relative group">
                ...
                <button
                  type="submit"
                  className="absolute right-0 top-1/2 -translate-y-1/2 p-2 hover:translate-x-1 transition-transform"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-6">
              <Instagram size={18} strokeWidth={1.5} className="cursor-pointer hover:text-gray-400 transition-colors" />
              <Facebook size={18} strokeWidth={1.5} className="cursor-pointer hover:text-gray-400 transition-colors" />
              <Twitter size={18} strokeWidth={1.5} className="cursor-pointer hover:text-gray-400 transition-colors" />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">
              © {currentYear} Petal + Pup. All rights reserved.
            </p>
