                            ...
                            >
                                ...
                                <div className="absolute bottom-16 left-8 right-8 text-white space-y-6">
                                    ...
                                    <Link
                                        ...
                                        onClick={closeStory}
                                        className="w-full py-5 glass text-black text-center text-[10px] font-black uppercase tracking-[0.4em] active:scale-95 transition-all inline-block group hover:bg-black hover:text-white"
                                    >
                                        Shop This Piece
                                        <ChevronRight size={14} className="inline-block ml-2 group-hover:translate-x-2 transition-transform" />
                                    </Link>
                                </div>
                            </motion.div>
