...
export default function HomeClient({ children }) {
    ...
    // Fetch Categories removed from direct initialData to support streaming children
    ...
    return (
        <div className="bg-white">
            ...
            <main id="main-content" className="relative">
                ...
                {/* Streamed content from Page.js (CategoryGrid and FeaturedProducts) */}
                {isDefaultParams ? (
                    children
                ) : (
                    /* Products Section for Filtering/Search */
