...
const loadCart = () => {
    ...
    try {
        const saved = localStorage.getItem('coolcache_cart');
...
const cartSlice = createSlice({
    ...
    reducers: {
        addToCart: (state, action) => {
            ...
            localStorage.setItem('coolcache_cart', JSON.stringify(state.items));
        },
        ...
        clearCart: (state) => {
            ...
            localStorage.setItem('coolcache_cart', JSON.stringify([]));
        },
        toggleCart: (state) => {
